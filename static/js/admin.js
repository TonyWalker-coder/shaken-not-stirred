...
document.addEventListener("click", (e) => {
  ...
  if (openTarget) {
    ...
    if (id === "imagesModal") {
      modalMessage(id, "success", "Loading images...");
      refreshImageList();
...
/* ============================================================
   IMAGES — UPLOAD (DELEGATED) + LIVE REFRESH
   ============================================================ */
...
/* ============================================================
   IMAGES — ASSIGN IMAGE TO COCKTAIL (CONFIRM MODAL)
   ============================================================ */
...
/* ============================================================
   LIVE COCKTAIL DROPDOWN (SORTED)
   ============================================================ */

async function refreshCocktailDropdown() {
  ...
  select.innerHTML = '<option value="">-- choose cocktail --</option>';
